...
public class ProductService {
  ...
  public Page<ProductResponseDTO> findAllPaged(Pageable pageable) {
    ...
    return prods.map(ProductResponseDTO::new);
  }

  @Transactional(readOnly = true)
  public ProductResponseDTO findById(UUID id) {
    return productRepository.findById(id).map(ProductResponseDTO::new).orElseThrow(
  ...
  public ProductResponseDTO save(ProductRequestDTO request) {
    ...
    return new ProductResponseDTO(fromDB);
  }

  @Transactional
  public ProductResponseDTO change(UUID id, ProductRequestDTO request) {
